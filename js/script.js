(function($) {
	...
	function headerStyle() {
		if($('.main-header').length){
			...
			//console.log(windowpos, siteHeaderHeight)
	...
	// console.log($('.main-header .main-menu li.dropdown ul').length)
	if($('.main-header .main-menu li.dropdown ul').length){
		...
		// console.log(this,$('.main-header .main-menu li.dropdown'))
		// $('.main-header .main-menu li.dropdown').on('click','.dropdown-btn', function(e) {
		// 	console.log('111')
		...
		//Megamenu Toggle
		$('.main-header .main-menu li.dropdown .dropdown-btn').on('click', function(e) {
            //console.log('222')
			$(this).prev('ul').slideToggle(500);
               e.stopPropagation && e.stopPropagation();
               e.cancelBubble && (e.cancelBubble = true);
